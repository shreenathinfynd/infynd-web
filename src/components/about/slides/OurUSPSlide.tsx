...
const OurUSPSlide = () => {
    ...
    const badges = [
        { text: "Strength", subtext: "180+ & Growing", position: "top-[10%] right-[15%]", bg: "bg-black" },
        { text: "Operations @", subtext: "Coimbatore", position: "top-[35%] right-[8%]", bg: "bg-black" },
        { text: "Head Quarters @", subtext: "United Kingdom", position: "top-[52%] right-[20%]", bg: "bg-red-600" },
        { text: "Founded in", subtext: "2020", position: "bottom-[28%] right-[22%]", bg: "bg-black" },
        { text: "B2B Data", subtext: "Provider", position: "bottom-[12%] right-[35%]", bg: "bg-red-600" }
    ];

    return (
        <div className="w-full h-full bg-white text-black flex flex-col">
            {/* Left Sidebar - About InFynd */}
            <div className="absolute left-0 top-0 bottom-0 w-8 bg-red-600 flex items-center justify-center">
                <div className="text-white font-bold text-sm tracking-widest" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>
                    ABOUT INFYND
                </div>
            </div>
            ...
            <div className="flex-1 pl-16 pr-12 py-12 overflow-y-auto">
                ...
                {/* Our USP Section */}
                <div className="mb-8">
                    <h2 className="text-3xl font-bold text-red-600 mb-6">Our USP</h2>
                ...
                <div className="relative mt-12 h-[300px]">
                    ...
                    <div className="absolute inset-0 flex items-center justify-start">
                        <svg viewBox="0 0 800 400" className="w-[550px] h-auto opacity-90">
                            {/* Simplified world map continents in red */}
                    ...
                    <div className="absolute top-[18%] right-[28%] w-20 h-20">
                        <div className="w-full h-full rounded-full border-4 border-blue-600 bg-white flex flex-col items-center justify-center shadow-lg">
                            ...
                            <div className="text-[8px] text-gray-600">9001:2015</div>
                        </div>
                    </div>
                    ...
                    {badges.map((badge, index) => (
                        <div
                            key={index}
                            className={`absolute ${badge.position} w-28 h-28 ${badge.bg} rounded-full flex flex-col items-center justify-center text-white shadow-xl`}
                        >
