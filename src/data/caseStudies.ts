...
export const caseStudies: CaseStudy[] = [
  {
    ...
    overview:
      "A leading payment processor offering card machines, contactless payments, and mPOS devices aimed to expand market coverage through a tele-appointment setting strategy to engage prospects and schedule sales meetings.",
      ...
      subPoints: [
        {
          title: "Data Coverage",
          items: [
            "3.2M (2M Micro Businesses) in United Kingdom",
...

  {
    ...
    overview:
      "To drive brand awareness and new customer acquisition for Indeed across 10 global markets, with a consistent yet locally adaptable outreach strategy.",
    ...
    solution: {
      title: "Solution",
      points: ["Designed and executed a segmented, multi-market audience strategy to maximise relevance and reach"],
      subPoints: [
        {
        ...
        {
          title: "Target Roles",
          items: ["Senior Decision makers", "HR Leaders and Talent acquisition stakeholders"],
        },
        {
...

  {
    ...
    overview:
      "A fleet management software provider needed to target specific fleet companies across the UK to promote their fuel card services and fleet management software. Traditional data collection methods were time-consuming and resulted in incomplete information, severely impacting their marketing efforts.",
    ...
    testimonial: {
      quote:
        "InFynd's custom-built data was a game-changer for our business. Not only did it help us generate new leads, but it also significantly improved our data quality thanks to their highly accurate and up-to-date information. We were able to target the right companies more effectively, save time, and ultimately increase our revenue by streamlining the entire fleet management process.",
    },
  },
];
