...
try:
    ...
    print("DATA_DICTIONARY_START")
    print(json.dumps(data_dictionary, indent=2))
    print("DATA_DICTIONARY_END")

    print("SAMPLE_DATA_COMPANY_START")
    print(json.dumps(sample_data_company, indent=2))
    print("SAMPLE_DATA_COMPANY_END")

    print("SAMPLE_DATA_CONTACT_START")
    print(json.dumps(sample_data_contact, indent=2))
    print("SAMPLE_DATA_CONTACT_END")
